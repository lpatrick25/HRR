...
class ResortPaymentController extends Controller
{
    /**
    ...
    {
        $billings = ResortPayment::with('resortTransaction', 'resortCottage')->get()->map(function ($payment, $index) {
            $transaction = $payment->resortTransaction;
            ...
            return [
                ...
                'cottage_name' => $transaction->resortCottage->cottage_name ?? 'N/A',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $validated = $request->validate([
                'resort_transaction_id' => 'required|exists:resort_transactions,id',
                'payment_method' => 'required|string|max:255',
                'amount_paid' => 'required|numeric|min:0',
                'checkout_session_id' => 'required|string|max:255',
            ], [
                'resort_transaction_id.required' => 'Resort transaction ID is required.',
                'resort_transaction_id.exists' => 'The selected resort transaction ID is invalid.',
            ...
            $transaction = ResortPayment::create($validated);
            ...
            return response()->json([
                'valid' => true,
                'msg' => 'Transaction successfully stored.',
            ...
            return response()->json([
                'valid' => false,
                'msg' => 'Failed to store transaction. Please try again later.',
            ], 500);
        }
    }
    ...
    public function show($id)
    {
        ...
        try {
            ...
            $transaction = ResortPayment::findOrFail($id);
