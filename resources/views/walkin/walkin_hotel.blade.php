    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <form id="walkInForm" class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Walk-In Hotel Check-In</h3>
            </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="text-center">
                            <div class="step-indicator" data-step="1"><i
                                    class="glyphicon glyphicon-calendar"></i><br>Number of Days</div>
                            <div class="step-indicator" data-step="2"><i
                                    class="glyphicon glyphicon-bed"></i><br>Available Rooms</div>
                        ...
                        <!-- Step 1: Number of Days to Stay -->
                        <div class="step-content mg-t-30" data-step="1">
                            <hr class="bg-danger">
                            <div class="form-group">
                                <label for="stay_days">Number of Days: <span class="text-danger">*</span></label>
                                <input type="number" class="form-control" name="stay_days" id="stay_days" required
                                    min="1" />
                                <small class="text-muted">Please enter the number of nights you will stay.</small>
                            </div>
                            <hr class="bg-danger">
                            <div class="row">
                        ...
                        <div class="step-content mg-t-30" data-step="2" style="display:none;">
                            ...
                            <table id="table3" data-toggle="table" data-click-to-select="true"
                                ...
                                <tbody>
                                    <!-- Dynamic room options will be populated here -->
                                </tbody>
                            </table>
                            <hr class="bg-danger">
                            <div class="row">
