...
@section('custom-css')
    ...
    <style>
        /* Parallax Header */
        .parallax-section {
            background: url("{{ asset('homepage/img/hero/cover1.jpg') }}") no-repeat center center fixed;
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="confirmation-container" data-aos="fade-up">
                        ...
                        <p>Your reservation has been successfully confirmed at <strong>Belle's Bistro Resort and
                                Hotel</strong>.</p>
