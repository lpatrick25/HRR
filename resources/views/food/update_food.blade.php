<div id="updateFoodModal" class="modal animated fadeIn" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form id="updateFoodForm" class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Update Food
            </div>
