...
@endsection
@section('APP_CONTENT')
    <table id="table1" data-toggle="table" data-click-to-select="true" data-single-select="true" data-url="/resortPayments"
        ...
        <thead>
            <tr>
                ...
                <th class="text-left" data-field="cottage_name">Cottage Name</th>
