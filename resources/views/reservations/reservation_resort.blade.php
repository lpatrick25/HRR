    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <form id="addForm" class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Add Resort Reservation</h3>
            </div>
                ...
                <div class="panel">
                    <div class="panel-body">
                        ...
                        <div class="text-center">
                            ...
                            <div class="step-indicator" data-step="3"><i class="glyphicon glyphicon-bed"></i><br>Cottage
                            </div>
                        ...
                        <div class="step-content mg-t-30" data-step="2" style="display:none;">
                            <hr class="bg-danger">
                            <div class="form-group">
                                <label for="booking_date">Reservation Date: <span class="text-danger">*</span></label>
                            ...
                            <table id="table2" data-toggle="table" data-click-to-select="true"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="cottage_type" data-formatter="cottageTypeFormatter">Cottage Type</th>
                                                ...
                                                <table class="table table-borderless">
                                                    <tbody>
                                                        ...
                                                        <tr class="content">
                                                            ...
                                                            <td class="font-weight-bold" id="arrivalTime">10:00 AM</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
