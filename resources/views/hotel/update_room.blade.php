<div id="updateRoomModal" class="modal animated fadeIn" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form id="updateRoomForm" class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Update Hotel Room
            </div>
