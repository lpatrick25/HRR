<div id="addTypeModal" class="modal animated fadeIn" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form id="addTypeForm" class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Add Hotel Type
            </div>
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="login-input-area">
                            <input type="text" name="type_description" id="type_description" />
                            <i class="fa fa-list login-user"></i>
                        </div>
                    </div>
                </div>
            </div>
