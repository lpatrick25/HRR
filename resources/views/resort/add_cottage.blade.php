<div id="addCottageModal" class="modal animated fadeIn" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form id="addCottageForm" class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Add Hotel Cottage
            </div>
